...
def parse_args():
    ...
    # `scenario_id` is autogenerated from target/penalty/tolerance when needed
...
def main():
    ...
    if args.process_nyc:
        ...
        # Generar scenario tag a partir de k/p/t (autogen), evitar exponer CLI
    ...
    if args.view_file is not None:
        # --view-file sin argumento -> construir ruta desde -k/-t/-p
        if args.view_file is True:
            ...
            fname = os.path.join(out_dir, f"route.csv")
